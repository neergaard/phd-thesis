...
\subsubsection{Construction and evaluation of a narcolepsy biomarker}
...
\begin{table}[t]
    ...
    % \begin{tabular}{@{}lcp{0.775\textwidth}@{}}
        \toprule
